...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO dietplan (id,diet,milkproduction,medicalemergency) VALUES (NULL, '$dietPlans','$milkProduction','$medicalHistory')";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE dietplan SET milkproduction='$milkProduction', diet='$dietPlans', medicalemergency='$medicalHistory' WHERE id='$recordId'";
...
if (isset($_POST['delete'])) {
    ...
    $sql = "DELETE FROM dietplan WHERE id='$recordId'";
...
<head>
    ...
    <title>Diet plans incase of emergency</title>
    <style>
          body {
...
<body>
    <h1>Diet plans in case of emergency</h1>
    <h2>Records</h2>
    <table>
        <tr>
            <th>ID</th>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row['id'] . "</td>";
                echo "<td>" . $row['diet'] . "</td>";
                echo "<td>" . $row['milkproduction'] . "</td>";
                echo "<td>" . $row['medicalemergency'] . "</td>";
                echo "</tr>";
            }
        } else {
    ...
    <form id="add-form" method="POST">
        ...
        <label for="medical-history">Medical Emergency:</label>
